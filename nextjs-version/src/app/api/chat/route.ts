...
export async function POST(req: NextRequest) {
  try {
    ...
    const { systemPrompt, messages, temperature, maxTokens, userApiKey } = body as {
      systemPrompt: string;
    ...
    const payload = buildPayload(systemPrompt, messages, { temperature, maxTokens, stream: true });
